...
namespace Aesthetic
{
    namespace test
    {
        ...
        std::array<LexerTest, 4> LexerTest::LoadTests(const std::string& testDirectory)
        {
            ...
            std::array<LexerTest, 4> entries = {
                ...
                LexerTest("Basic Loop Example"s, testDirectory + "/examples/loop.ae", testDirectory + "/examples/loop.txt"),
            };
            return entries;
        }
    } // namespace test
